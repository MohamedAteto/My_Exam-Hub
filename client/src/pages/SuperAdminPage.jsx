...
export default function SuperAdminPage() {
  ...
  useEffect(() => {
    ...
    if (!token) {
      ...
      // If user is logged in but not an admin, navigate to their respective dashboard
        ...
        return (
          <div style={{ padding: '2rem', background: '#f9fafb', minHeight: '100vh' }}>
            <div className="content-header" style={{ marginBottom: '2rem' }}>
              <h1 className="content-title" style={{ fontSize: '2rem', fontWeight: 700, color: 'var(--text-primary)' }}>Teachers</h1>
              <p className="content-subtitle" style={{ fontSize: '1rem', color: 'var(--text-secondary)' }}>Manage teacher accounts (Coming Soon)</p>
            </div>
            <div style={{ background: 'white', padding: '2rem', borderRadius: '12px', boxShadow: 'var(--shadow-sm)', textAlign: 'center' }}>
              <p>Teacher management functionality is currently under development.</p>
            </div>
          </div>
        )
      case 'students':
              ...
              <div style={{
                ...
                <div>
                  ...
                  <p style={{ margin: '0.25rem 0 0', opacity: 0.8, fontSize: '0.9rem' }}>
                    You are logged in as a <span style={{ color: 'white', fontWeight: 600 }}>{userRole || 'SuperAdmin'}</span>
                  </p>
                </div>
                <div style={{
